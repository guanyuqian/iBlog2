    ...
    SearchControl.prototype = {
        ...
        , _getHtml: function () {
            var html = [
                ...
                '<div id="BMapLib_sc0">',
                '<table style="min-width:150px;width:30%" border="0" cellpadding="0" cellspacing="0">',
                '<tr >',
                '<td style="display:none">',
                '<div id="BMapLib_cityTab" class="BMapLib_cityTab" style="">',
                '<span>北京市</span>',
                ...
                '</td>',
                '<td>',
                '<div class="BMapLib_sc_t_b sc_btn  btn-info btn-search" id="BMapLib_sc_b0">搜索</div>',
                '</td>',
                '</tr>',
                '</table>',
                '</div>',
